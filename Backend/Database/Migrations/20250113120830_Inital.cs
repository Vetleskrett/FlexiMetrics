    ...
    public partial class Inital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TeamNr = table.Column<int>(type: "integer", nullable: false),
                    CourseId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignmentFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssignmentFields_Assignments_AssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamUser", x => new { x.StudentsId, x.TeamId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentFields_AssignmentId",
